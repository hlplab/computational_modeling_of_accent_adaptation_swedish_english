...
d.exposure = 
  d.swedish %>%
  filter(Block.Type == "exposure") %>%
  select(NativeLanguage, Group, Participant, 
  ...
  full_join(d.english.exposure %>%
              ...
              mutate(Count = NULL),
            by = c("NativeLanguage", "Group", "Participant", 
                   "Block.Type", "Item.Type", "Item.WordStatus", 
                   "LD.Correct")) %>%
    mutate_at(
    c("NativeLanguage", "Group", "Participant", "Block.Type", "Item.Type", "Item.WordStatus"),
    .funs = factor
  )
```
...
ggsave(filename = "../figures/Result-ratings.png",
       width = 7, height = 4)
```

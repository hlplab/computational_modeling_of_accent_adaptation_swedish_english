...
### English ###
Unfortunately, the trial-level exposure data from Xie et al. (2017) was lost in a laptop theft in 2018. We do, however, have access to the mean by-participant accuracies and their standard deviation. Lexical decision accuracy for filler response accuracy was high (M = `r round((80 * 60 + 77 * 90 + 81 * 30) / 180, 0)`\%), and did not differ much between filler words (M = 80\%, SD = 6\%) and nonwords (M = 77\%, SD = 16\%). Accuracy was also high for critical words with syllable-final /d/ in the /d/-exposure group (M = 81\%, SD = .09\%). No reaction time data was available.

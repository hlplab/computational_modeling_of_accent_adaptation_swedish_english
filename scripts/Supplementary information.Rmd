...
```{r bootstrap-downsampling, warning=F, fig.cap = "(ref:bootstrap-downsampling)", fig.height=4, out.width='50%'}
set.seed(333)
...
d.bootstrap %>%
  ...
  geom_vline(xintercept = original.tvalue, color = "black") +
...
(ref:bootstrap-downsampling) Distribution of $t$-values for the (simple effects) two-way interactions between exposure group (/d/-exposure vs. control) and sound (/d/ vs. /t/) across the `r n.bootstrap` bootstrap samples. The $t$-value of the two-way interaction in the original English data from Xie et al. (2017) is indicated by the black vertical line.

...
d.test = d.swedish %>%
  ...
  mutate(
    Language = factor(Language, levels = c("Mandarin-accented English", "Flemish-accented Swedish")),
...
d.exposure = 
  ...
  mutate_at(
    c("Group", "Participant", "Block.Type", "Item.Type", "Item.WordStatus"),
    .funs = factor
  )
```
...
knitr::include_graphics("../figures/ideal observers and data.png")
```

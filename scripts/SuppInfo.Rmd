...
The Swedish experiment employed fewer test stimuli (64 \/d-\/t\/-final words from 32 minimal pairs,  e.g., *röd* and *röt*). <!-- Maryann: right? or was it 16 pairs? Xin seems to have used 60 *pairs* --> Additionally, test words were allwed to have word-initial voiced stops (other than /d/, e.g. *bädd-bett*).

<!-- Maryann: I made an edit here to clarify lack of balancing. let me know if it's correct? -->
...
Finally, the Swedish experiment contained a third and fourth test block during which participants rated 54 words from 27 \/d\/-\/t\/-*initial* minimal pairs (e.g., *dom* and *tom*). <!-- Maryann: I changed this to the number of trials I found in the data -->

...
### English ###
<!-- This needs to be made more parallel to the Swedish description. was order randomized? -->
The /d/-exposure group heard 30 critical words with between three and four syllables, ending with \/d\/, and without \/t\/-final minimal pair neighbors (e.g. \textit{overload}). The 30 words for the control group (e.g., animal) were matched to the critical /d/-words in syllable length and mean lemma frequency (based on CELEX, Baayen, Piepenbrock, & Gulikers, 1995). All words or nonwords were multisyllabic and contained three to four syllables. Other than the critical /d/-final words, no other alveolar stops, voiced stops, dental fricatives, and postalveolar affricates occured. The voiceless stops (/k/ and /p/) did not appear in word-final position. 

### Swedish ###
<!-- Maryann: fill in XXXs? -->
Participants indicated their response on each trial by pressing the “j” key for “ja (yes)” and “n” key for “nej (no)”. 
...
The 30 words for the control group did not contain \/d, t, b, g\/, and were matched in syllable length and average base form frequency (based on the 25 million word database of Språkbanken, https://spraakbanken.gu.se/korp, accessed January 2019). The words were presented in random order.

Unintended by the design, one critical word in the /d/-exposure group contained a word-medial syllable-initial /d/ (*medellivslangd*---`average life span'), one pseudoword contained word-medial syllable-initial /d/ (*mörvinder*---`XXX'), and one pseudoword contained word-final /t/ (*spållrivet*---`XXX').
...
<!-- Maryann: I edited this quite a bit since I did not follow some of your arguments. please check what I wrote and whether it makes sense to you? btw, after comments are addressed, you can delete them.

Please check whether we should use non-word or pseudoword. change it to be uniform
-->
...
The Swedish experiment employed fewer test stimuli (32 \/d-\/t\/-final words from 16 minimal pairs,  e.g., *röd* and *röt*). <!-- Maryann: right? 16 minimal pairs, forming 32 words, or 32 mps forming 64 words? --> Additionally, test words were allwed to have word-initial voiced stops (other than /d/, e.g. *bädd-bett*).

<!-- Maryann: made an edit here to clarify lack of balancing. let me know if it's correct? -->
Due to a misunderstanding, the Swedish data did not counter-balance whether a word recording was rated for /d/- or for /t/-goodness (e.g., the word *XXX* was always rated for /d/-goodness; the word *XXX* was always rated for /t/-goodness; across minimal pair words, /d/- and /t/-final words were equally often rated for /d/- and /t/-goodness).

Finally, the Swedish experiment contained a third and fourth test block during which participants rated 32 \/d\/-\/t\/-*initial* minimal pair words (e.g., *dom* and *tom*). The order of these later test blocks was counter-balanced across participants but participants always completed the test block with word-final ratings *before* performing the word-initial ratings. The data from word-initial ratings tasks are not part of the current analysis, though we note that exposure group did not affect the Swedish word-initial ratings either.

### Why these differences?
The Swedish experimen employed fewer test tokens because it was difficult to find additional minimal pairs for Swedish. While there are many /d/-/t/-final minimal pairs in Swedish, a large number of them are different forms of the same word and hence semantically identical (e.g., *XXX*---`XXX' and *XXX*---`XXX'). <!-- Maryann: please explain: not sure what you meant here. perhaps the examples and their translations will help -->
The same reason motivated the decision to allow test stimuli in which voiced stops (other than /d/) occurred at the word onset.
...
### Are these differences likely to explain the results?
Compared to the English experiment, the Swedish experiment had 50\% fewer items. The resulting reduction in power could explain the null effect for Swedish. This possibility was ruled out by bootstrap analyses reported in Section XXX.

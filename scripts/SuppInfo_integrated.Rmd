...
##-----------------------
# Swedish rating data
d.pilot.swedish = read_csv(file = "../data/Swedish/pilot_test/testrun2.csv")
# English rating data
d.xin <- read.csv("../data/English/d.rating.xin.csv")
...
d.pilot.swedish %<>%
  ...
  mutate(
    ...
    Word = str_replace(stri_trans_general(Item.Filename, "Latin-ASCII"), "^[A-Z]+_[0-9]+_([a-z]+)_.*$", "\\1"),
  ...
  select(Language, List, 
         ...
         Sound.Type, Sound.Position, Word, MinimalPairID,
...
# Combine Swedish and English here -- NOT YET combined here because the Swedish data contains both exposure and test; the English data contains only test
d = d.pilot.swedish %>%

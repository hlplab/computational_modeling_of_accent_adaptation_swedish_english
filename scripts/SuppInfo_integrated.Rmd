...
### Swedish vs. English
Overall, accuracy during exposure was substantially higher in the English data, compared to the Swedish data. This is consistent with the analyses of the test ratings we present below, which suggest that the Flemish-accented Swedish speech was considerably easier to process for native Swedish listeners than the Mandarin-accented English speech was for native English listeners.
...
* Swedish: 23 participants (11 experimental, 12 control); 30 word pairs
each participant rated each word (one of the pair) either for goodness as /d/ or for goodness as /t/, resulting in 16 ratings per sound category (/d/ vs. /t/) per rating type (goodness as /d/ vs. goodness as /t/) and 64 ratings per participant.
Total observations:  23 * 15 * 2 * 2 = 1380

* English: 48 participants (24 experimental, 24 control); 60 word pairs
each participant rated each word (one of the pair) both for goodness as /d/ and for goodness as /t/, resulting in 30 ratings per sound category (/d/ vs. /t/) per rating type (goodness as /d/ vs. goodness as /t/) and 120 ratings per participant.

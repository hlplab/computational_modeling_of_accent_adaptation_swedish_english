      ...
      p = plot_ly(
        ...
        add_markers(x= ~vowel,
                  ...
                  marker = list(color = ~Model.Posterior.Intended.Difference,
                                ...
                                colorscale = list(c(0,'rgba(9, 1, 95,0.9)'),
                                                  list(0.5,'rgba(236, 237, 231,0.9)'),
                                                  list(1,'rgba(235, 94, 11,0.9)')), 
                                cmin = -1,
                                cmid = 0,
                                cmax = 1,
      ...
      mode="markers"
        ...
        add_markers(x= ~vowel,
                  ...
                  marker = list(
                     ...
                     cauto = T,
                     autocolorscale = F,
                     colorscale = list(c(0,'rgb(0, 65, 106)'), list(0.5,'rgb(121, 159, 12)'), list(1,'rgb(255, 224, 0)')),
                     cmin = 0,
                     cmid = 0.5,
                     cmax = 1,
                     colorbar = list(len = 0.7, title = 'Model-predicted posterior\nof intended category'),
                     line = list(color = ~Sound, colors = list(c("red", "blue")), width = 1)
        )) 
  } else p = plot_ly()

...
# I compared the correct_for_suprasegmental_context() function with and without an offset. The number of terms extracted are the same but term values are different when the model does not include the offset. Presumably this means that the offset is added to the terms 
...
# store the step2 values as r<cue>
d.stims.step2 %<>% mutate(
  rvowel = rvowel.step2,

...
# try plotting. The figures are mmoving in the opposite direction to the previous fitting method. Don't know if this makes sense. For English, the general pattern of d-exposure-matching performing better than control-matching is there, and d-exposure-nonmatching worse than control-non matching. This is stable all the way. The Swedish data looks a bit crazy.

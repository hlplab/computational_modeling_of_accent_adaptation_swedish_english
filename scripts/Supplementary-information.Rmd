...
l = lm(y ~ 1 + number_syllables + has_stress,
       data = data.fit,
       offset = data.fit$offset_segmental
       )
...
get_predictions_for_suprasegmental_context = function(
  ...
  return(
    rowSums(
      predict.lm(l,
                 newdata = newdata,
                 type = "terms", # terms of a model also includes offset maybe  --does terms include offset or not, if a linear model includes offsets check whether terms include offset or not  

...
correct_for_word_length = function(cue.name, 
  ...
  f = formula(
    case_when(
      ...
      language == "Swedish" ~ "y ~ 1 + Accent / (number_syllables + has_stress + rsyllable_duration)",
      T ~ NA_character_))
...
Second, we estimate the effects of phonological factors (word length, lexical stress) and speaking rate (residualised syllable duration) affect cue duration. We fitted three separate linear regressions for English native: `lm(cue ~ 1 + rsyllable_duration)`, English non-native: `lm(cue ~ 1 + number_syllables + has_stress + rsyllable_duration)`, and Swedish: `lm(cue ~ 1 + Accent / (number_syllables + has_stress + rsyllable_duration))`, using /d/-final words. 

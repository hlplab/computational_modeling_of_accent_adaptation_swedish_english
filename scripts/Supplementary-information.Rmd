...
```
### K-fold Cross-Validation of ideal observer models
In addition to testing the ideal observer models on the respective non-native talker test data we ran 5-fold cross-validation on each of the models to estimate their test error rate.
...
#Filter d.IO.CV into 5 training sets and pipe into train_IO, create a column indicating training round

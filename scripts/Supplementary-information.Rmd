...
- onset has nasal
- coda has nasal
- onset has rhotic and
- Talker

The model comparisons employed a group cross-validation method with the backward step-down approach for each training sample. The final models for the respective cues for English were as follows:

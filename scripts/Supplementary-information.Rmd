...
Supra-segmental factors like---lexical stress and speech rate---are also known to affect the phonetic realization of sounds. For example, segments tend to have longer durations in stressed, compared to unstressed, syllables (Lindblom, 1963; Van Summers, 1987). Processes like compensatory lengthening/shortening (Peterson & Lehiste, 1960; Lindblom & Rapp, 1973; Fowler, 1981) can also cause segments to be longer in syllables with fewer segments (REF), and words with fewer syllables (Warner et al., 2004). <!-- Xin, Maryann: pls fill ref --> Additionally, local changes in speech rate are likely to affect durational measures like the ones used here (e.g. Crystal & House, 1982; Gahl et al., 2012; Tsao et al). Given that non-native speakers tend to speak more slowly, it is necessary to control for cue duration variation caused by differences in speaking rate. We thus removed effects of speech rate, lexical stress, and syllable/word complexity on vowel, closure, and burst duration.

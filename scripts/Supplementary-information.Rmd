...
d.stims.swedish <- read.csv("../data/Swedish/Swedish_production_exposure+test_Tan et al 2019.csv") %>%
...
d.stims.english <- read.csv("../data/English/English_production_exposure+test_Xie et al 2017.csv")
d.stims.LiETAL <- read.csv("../data/English/English_production_Li et al 2020.csv")
```

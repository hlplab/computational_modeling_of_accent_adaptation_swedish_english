---
title: "Supplementary Information for PAPER TITLE_testing with raw measures: Step 1 & 2 (n_syllable only; English and Swedish both use old correction method step 2) & 3; talkers with high release; correct by speaker"
...
my.resids.length = function(var.name, data.fit, data.pred) {
  ...
  l = lm(y ~ 1 + number_syllables, data = data.fit)
  print(summary(l))

...
Supra-segmental factors like---lexical stress and speech rate---are also known to affect the phonetic realization of sounds. For example, segments tend to have longer durations in stressed, compared to unstressed, syllables (@lindblom1963spectrographic; @van1987effects). Processes like compensatory lengthening/shortening (@peterson1960duration; @lindblom1973some; @fowler1981relationship) can also cause segments to be longer in syllables with fewer segments (REF), and words with fewer syllables (Warner et al., 2004).<!--Florian: are you referring to anticipatory shortening? --> Additionally, local changes in speech rate are likely to affect durational measures like the ones used here (e.g. @crystal1982segmental; @gahl2012reduce). Given that non-native speakers tend to speak more slowly, it is necessary to control for cue duration variation caused by differences in speaking rate. We thus removed effects of speech rate, lexical stress, and syllable/word complexity on vowel, closure, and burst duration.

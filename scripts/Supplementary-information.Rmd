...
##-----------------------
# Swedish rating data
d.swedish = read_csv(file = "../data/Swedish/Swedish_perception_exposure+test.csv")
# English rating data
d.english.exposure <- read.csv("../data/English/English_perception_exposure.csv")
d.english.test <- read.csv("../data/English/English_perception_test.csv")
...
# load stimuli
d.stims.swedish <- read.csv("../data/Swedish/test_stimuli_analysis/Swedish_production_exposure+testcsv") %>%
...
read_csv("../data/English/English_perception_test.csv") %>% 

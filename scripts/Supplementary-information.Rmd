...
# load stimuli
d.stims.swedish <- readRDS("../data/Swedish/test_stimuli_analysis/d.stims.swedish.rds") %>%
...
d.stims.english <- readRDS("../data/English/d.stims.english.rds")
  

d.stims.database <- readRDS("../data/English/d.stims.database.rds")

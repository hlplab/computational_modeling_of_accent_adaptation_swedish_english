...
knitr::opts_chunk$set(echo = FALSE, 
                      message=FALSE, warning=FALSE, error=TRUE, cache = TRUE,
                      fig.width = 4.5,
                      fig.height = 4)
```
...
We first evaluated the two folded models on the entire test set, following the same procedure outlined in Section \@ref(sec:IO-test). Figure \@ref(fig:IO-ratings-results-byItem-wTraining_folds) plots the predictions of the ideal observers. 
...
```{r IO-ratings-results-byItem-wTraining_folds, fig.cap="(ref:IO-ratings-results-byItem-wTraining_folds)", fig.height=8.5, out.width='75%'}

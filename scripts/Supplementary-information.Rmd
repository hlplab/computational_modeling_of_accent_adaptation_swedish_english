...
m1 <- train_IO(exclude(d.IO.training.CV,1), selected_cues, 1)
m2 <- train_IO(exclude(d.IO.training.CV,2), selected_cues, 2)
m3 <- train_IO(exclude(d.IO.training.CV,3), selected_cues, 3)
m4 <- train_IO(exclude(d.IO.training.CV,4), selected_cues, 4)
m5 <- train_IO(exclude(d.IO.training.CV,5), selected_cues, 5)
```

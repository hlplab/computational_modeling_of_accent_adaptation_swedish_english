...
Our initial analysis did not employ cross-validation or similar methods. This decision was made since the training data do not overlap with the test data. During the review process, reviewers raised questions about the amount of data that would be required for the type of computational analysis conducted here. Here we address this questions by subsetting the training and test data to assess the variability of the results across cross-validated folds of the training and test data. This allows us to assess the extent to which the results in the previous section are due to overfitting to the training data. 
...
get_average_log_likelihood <- function(data, lapse_rate = 0.1, bias.d = .5) {
  data %>% 
    mutate(
      prediction.d = (1 - lapse_rate) * Model.Posterior.d + lapse_rate * bias.d,

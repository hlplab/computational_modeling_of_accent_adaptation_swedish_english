...
tab_model(lmer.IOtoRating.full,
          show.r2 = F,
          title = "(\\#tab:ratings-IO-analysis) Results of linear mixed-effects regression of /d/-goodness ratings on ideal observer posterior /d/ predictions with full interactions of native language, exposure group and sound.",
          pred.labels = pred.labels,
          dv.labels = "/d/-goodness rating (z-scored)")
```

...
=======
colors.Category = c( "lightblue", "orange")
>>>>>>> 85281acf2c76fff664b4084cf00a9f23b74b3b33
...
```{r step 3 align to /t/ category from non-native test words, include = FALSE, eval=FALSE}
...
```{r compute-ideal-observers-training-density, include = FALSE}
...
```{r function-bivariate-gaussian-distribution-density, include = FALSE}
...
```{r compute-IO-training-model-density-2d, include = FALSE}
...
```{r fig-ideal-observers-training-density, fig.cap="(ref:ideal-observers-training-density)", fig.height=4.5, out.width="75%"}
...
```{r fig-ideal-observers-categorization, fig.cap="(ref:ideal-observers-categorization-function)", fig.height=4.5, out.width="75%"}

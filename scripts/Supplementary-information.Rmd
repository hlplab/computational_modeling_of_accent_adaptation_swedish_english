...
### Cross-Validation of ideal observer models
In addition to testing the ideal observer models on the respective non-native talker test data we cross-validated the data to check the stability of the results. 

Each model's training data was apportioned into 5 sets. For each iteration of ideal observer training, all but one of the test sets were used; the left-out test set was reserved for validation. This process is reiterated until all five test sets are exhausted.
